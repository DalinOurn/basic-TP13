...
export default {
  ...
  async mounted() {
    ...
    const response = await fetch(
      "http://35.78.79.160:3001/category/all",
      requestOptions
    );
    // const product = await fetch(
    //   "http://35.78.79.160:3001/product/id/6247762f802a20af6b94a71e",
    //   requestOptions
    // );
  ...
  methods: {
    ...
    async editPriceData() {
      ...
      const response = await fetch(
        `http://35.78.79.160:3001/price/update`,
        requestOptions
      );
      await response.json();
      ...
      const response_1 = await fetch(
        `http://35.78.79.160:3001/product/each-shop`,
        requestOptions_1
      );
    ...
    async editBtn(id) {
      ...
      const item = await fetch(
        `http://35.78.79.160:3001/item/id/${this.productData.data.item}`,
        requestOptions1
      );
      this.productItem = await item.json();

      const category = await fetch(
        `http://35.78.79.160:3001/category/id/${this.productItem.data.category}`,
        requestOptions1
      );
    ...
    async addPrice() {
      ...
      const response = await fetch(
        "http://35.78.79.160:3001/price/create",
        requestOptions
      );
      await response.json();
      // POST request using fetch with async/await
    ...
    async items() {
      ...
      const response = await fetch(
        "http://35.78.79.160:3001/item/all",
        requestOptions
      );
      const data = await response.json();
      // console.log(data);
    ...
    async products() {
      ...
      const response = await fetch(
        "http://35.78.79.160:3001/product/all",
        requestOptions
      );
      const data = await response.json();
      this.titleData = data;
    ...
    async createData(numofPage) {
      if (numofPage == 1) {
        ...
        const response = await fetch(
          "http://35.78.79.160:3001/category/add",
          requestOptions
        );
        await response.json();
        ...
        const response = await fetch(
          "http://35.78.79.160:3001/item/add",
          requestOptions
        );
        await response.json();
        this.titleData.data[this.numOfCate] = {
        ...
        const response = await fetch(
          "http://35.78.79.160:3001/product/add",
          requestOptions
        );
        await response.json();
        this.products();
    ...
    async deleteData(idofData) {
      if (this.page == 1) {
        ...
        const response = await fetch(
          "http://35.78.79.160:3001/category/remove",
          requestOptions
        );
        await response.json();
        this.category();
        ...
        const response = await fetch(
          "http://35.78.79.160:3001/item/delete",
          requestOptions
        );
        await response.json();
        this.items();
        ...
        const response = await fetch(
          "http://35.78.79.160:3001/product/delete",
          requestOptions
        );
        await response.json();
        this.products();
    ...
    async deletePriceData(pId, id) {
      ...
      const response = await fetch(
        "http://35.78.79.160:3001/price/delete",
        requestOptions
      );
      await response.json();
      // POST request using fetch with async/await
